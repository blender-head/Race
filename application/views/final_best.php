           		...
           		<table id="all-racer"><!--all-racer-->
                    ...
                    <?php 
						...
						for($i=0;$i<count($records_1);$i++)
						{
							...
							echo '<input type="hidden" name="racer_pengda[]" value="' . $records_1[$i]->racer_pengda . '"/>';
							...
							echo '<td class="racer_time_col"><input type="text" name="racer-time[]" class="summary-racer-time" /></td>';
							echo '<td class="racer_time_col"><input type="text" name="racer-best[]" id="racer-best" /></td>';
							echo '<input type="hidden" name="race_type[]" value="' . $records_1[$i]->race_type . '"/>';
							echo '<input type="hidden" name="class_id[]" value="' . $records_1[$i]->class_id . '"/>';
							echo '</tr>';
						}
						...
						for($z=0;$z<count($records_2);$z++)
						{
							...
							echo '<input type="hidden" name="racer_pengda[]" value="' . $records_2[$z]->racer_pengda . '"/>';
							...
							echo '<td class="racer_time_col"><input type="text" name="racer-time[]" class="summary-racer-time"/></td>';
							echo '<td class="racer_time_col"><input type="text" name="racer-best[]" id="racer-best"/></td>';
							echo '<input type="hidden" name="race_type[]" value="' . $records_2[$z]->race_type . '"/>';
							echo '<input type="hidden" name="class_id[]" value="' . $records_2[$z]->class_id . '"/>';
							echo '</tr>';
						}
