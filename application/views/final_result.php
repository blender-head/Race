    	...
    	<div id="data">
        	...
        	<div id="qtt-header-summary"><!--qtt-header-->
            	...
            	<div id="qtt-header-summary-tag">
                	...
                	<h2><?php echo $site_title_sub ?></h2>
                	<p><?php echo $site_track ?></p>
                	<p><?php echo $date ?></p>
               </div>
                    ...
                    <div class="summary-item">
                    	<table class="qtt-header-data">
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="qtt_name" value="<?php echo $qtt_name ?>" />
                                <?php 
            ...
            <div id="table-data">
                ...
                <div class="print-summary">  
                	<?php echo anchor('racers/export_pdf_final/' . $this->uri->segment(3). '/' . $this->uri->segment(4) . '/' . $qtt_name,'Print') ?>
                </div>
