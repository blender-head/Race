...
<div id="wrapper"><!--wrapper-->
    ...
    <div id="content"><!--content-->
    	...
    	<div id="data"><!--data-->
            ...
            <h2 class="data-exist"><?php echo $exist ?></h2>
            		...
            		<table id="all-racer"><!--all-racer-->
                    	...
                    	<?php if(sizeof($records) > 0) : ?>
                            ...
                            <tr>
                                ...
                                <td class="racer_name_col"><?php echo anchor("racers/edit/$row->id", "$row->racer_name") ?></td>							<input type="hidden" name="racer_name[]" value="<?php echo $row->racer_name ?>" />
                                  	...
                                  	<select name="race_type[]" id="race_type">
                                   		<?php if (sizeof($race_type > 0)) : ?>
                               				<?php foreach ($race_type as $option) : ?>
                                        		<option value="<?php echo $option->race_type_id ?>"><?php echo $option->race_type_name ?></option>											<?php endforeach ?>
                                     <?php endif  ?>
                                     </select>
                              </td>
