...
<div id="wrapper"><!--wrapper-->
    ...
    <div id="content"><!--content-->
    	...
    	<div id="data"><!--data-->
        	...
        	<div id="qtt-header-summary"><!--qtt-header-summary-->
            
           		<div id="starting-list"><!--starting-list-->
                    	<h2>Starting List</h2>
            	...
            	<div id="qtt-header-summary-tag"><!--qtt-header-summary-tag-->
            		<h1><?php echo $title ?></h1>
                	<h2><?php echo $champions ?></h2>
                	<p><?php echo $date ?></p>
                	<p><?php echo $location ?></p>
               	</div><!--/qtt-header-summary-tag-->
               
               	<div class="summary-item"><!--summary-item-->
