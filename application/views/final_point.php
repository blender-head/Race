        	...
        	<div id="table-data"><!--table-data-->
				...
				<table id="qtt-header"><!--qtt-header-->
                	...
                	<tr>
                    	...
                    	<td class="qtt-data"><?php if(count($records) > 0) { echo $final; } else { echo "No data"; } ?></td>
           		...
           		<table id="all-racer"><!--all-racer-->
                    ...
                    <?php foreach($records as $row): ?>
                    	...
                    	<tr>
                        	<td class="racer_no_col"><?php echo $i++ ?></td>
                            ...
                            <td class="racer_point_one_col"><input type="text" name="racer-point-one[]" id="point_one" value="<?php echo $row->point_one ?>"/></td>
							<td class="racer_point_two_col"><input type="text" name="racer-point-two[]" id="point_two" /></td>
							<td class="racer_total_col"><input type="text" name="total[]" id="total" /></td>
